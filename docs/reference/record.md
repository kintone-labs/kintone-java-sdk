...
| --- | --- | --- | --- |
| app | Integer | yes | The kintone app ID
| records | Array<[RecordUpdateItem](../record-model/#recordupdateitem)> | yes | The records data which will update to kintone app
...
| --- | --- | --- | --- |
| app | Integer | yes | The kintone app ID
| records | Array&lt;HashTable&lt;String, [FieldValue](../record-field-model#fieldvalue)&gt;&gt; | yes | The records data which will add to kintone app
